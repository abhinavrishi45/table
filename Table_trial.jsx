...
const modulesList = [
  ...
  "Resilience & Grit",import React, { useState } from "react";
...
const moduleDetails = {
  "Time / Energy Management": "Techniques to manage energy and time for productivity and wellbeing.",
  "Psychological Safety & Culture": "Creating environments where individuals can speak up without fear.",
  "Resilience & Grit": "Building the capacity to recover from setbacks and persist.",
  "Leadership Skills": "Developing decision making, delegation and people management abilities.",
  "Communication": "Improving verbal, written and interpersonal communication skills.",
  "a": "Placeholder details for module a.",
  "b": "Placeholder details for module b.",
  "c": "Placeholder details for module c.",
  "d": "Placeholder details for module d.",
  "e": "Placeholder details for module e.",
  "f": "Placeholder details for module f.",
};
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 20 }}>
        ...
        <div>
          ...
          >
            ...
            {modulesList.map(m => (
              <option key={m} value={m} title={moduleDetails[m] || ""}>
                {m}
              </option>
            ))}
          </select>
            ...
            >
              ...
              <td style={tdStyle}>
                <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
                  ...
                  <span
                    title={moduleDetails[row.module] || (row.custom ? "Custom module" : "No details available")}
                    style={{ marginLeft: 6, cursor: "help", color: "#1f3a6d" }}
